...
def crypt_file():
    ...
    # Generate stub
    stub_code = StubGenerator.generate_stub(encrypted_data, key, iv, method, original_name)
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="result-box">
                ...
                <p style="color:#8899bb; font-size:12px; margin-top:10px;">💡 Run the .py stub to execute the decrypted payload (requires Python).</p>
            </div>
            {% endif %}
        </div>
    </div>
